$(document).ready(function() {
	 ...
	 */
	var skill1 = '5';
	/* change number to suit your skills (HTML)*/
	var skill2 = '5';
	/* change number to suit your skills (CSS)*/
	var skill3 = '3';
	/* change number to suit your skills (.Net)*/
	var skill4 = '3.5';
	/* change number to suit your skills (Javascript)*/
	var skill5 = '3.5';
	/* change number to suit your skills (jQuery)*/
	var skill6 = '4	';
	/* change number to suit your skills (Adobe Photoshop)*/
	var skill7 = '3';
	/* change number to suit your skills (Adobe Firewoks)*/
	...
	/* prettyPhoto */
	$("#gal a[rel^='prettyPhoto']").prettyPhoto({
	...
	$('.menuButton, .logo').click(function(e) {
		...
		$('.about, .contact').parent('li').animate({
			...
			borderBottomRightRadius : 0,
			opacity : 1
		}, 400, 'easeOutBack').css('backgroundColor', '#1f1f1f');
	...
	$('.item').click(function() {
		...
		if (thisItem != "all") {
			...
			$('ul#chooseW li[rel=' + thisItem + ']').stop().animate({
				'width' : '120px',
				'opacity' : 1,
				'marginLeft' : '20px'
			});
